...
export const budgetData: BudgetCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'act-guimaraes', label: 'Guimarães day trip — train + castle/palace + lunch', estimated: 160, currency: 'EUR', note: 'Train ~€8 pp × 4 + combo entry ~€8 pp × 4 + lunch in old town' },
      ...
      { id: 'act-jeronimos', label: 'Jerónimos Monastery + Belém Tower (Aug 30 Sun)', estimated: 48, currency: 'EUR' },
